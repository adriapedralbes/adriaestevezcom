    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-xl shadow-md p-8 md:p-12">
          ...
          <h3 className="text-xl font-bold mb-4 text-gray-900">What You Will Learn</h3>
          ...
          <div className="mt-8 pt-8 border-t border-gray-100">
            <div className="flex items-center gap-4">
              <div className="flex-shrink-0">
                <img src="/profile-pic.svg" alt="Adria Estevez" className="w-16 h-16 rounded-full" />
              </div>
              <div>
                <h4 className="font-bold text-gray-800">Adria Estevez (@adriadev)</h4>
                <p className="text-gray-600">YouTuber, Entrepreneur, AI Expert</p>
